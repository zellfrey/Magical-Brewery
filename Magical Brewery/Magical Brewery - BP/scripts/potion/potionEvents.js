...
//Splash Potion Events
world.beforeEvents.itemUse.subscribe((e) => {
	PotionManager.setThrownPotionData(e.source, e.itemStack, system.currentTick);
});

world.afterEvents.entitySpawn.subscribe((eventData) => {
	PotionManager.handlePotionSpawned(eventData);
	
});
	
world.afterEvents.projectileHitBlock.subscribe((eventData) => {
    PotionManager.handlePotionProjectile(eventData);
});
